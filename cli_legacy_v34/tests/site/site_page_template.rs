mod site_page_template {
    ...
    pub fn basic() {
        ...
        let left = Some("pages/post/published.neojinja".to_string());
    ...
    pub fn custom_template_type() {
        ...
        let config = Config::set2();
        let site = Site::new(&file_set, &config);
        let left = Some("pages/custom-template-type/published.neojinja".to_string());
    ...
    pub fn custom_template_status() {
        ...
        let config = Config::set2();
        let site = Site::new(&file_set, &config);
        let left = Some("pages/post/custom-template-status.neojinja".to_string());
