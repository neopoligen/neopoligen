...
impl PayloadSpan {
    pub fn new_from_span(span: &Span, config: &SiteConfig) -> PayloadSpan {
        ...
        let r#type = match &span.kind {
            ...
            SpanKind::CodeShorthand => "code-shorthand".to_string(),
            SpanKind::Colon => "colon".to_string(),
            SpanKind::ColonNotFollowedBySpace => "colon-not-followed-by-space".to_string(),
            SpanKind::DoubleUnderscore => "double-underscore".to_string(),
            SpanKind::EmShorthand => "em-shorthand".to_string(),
            SpanKind::EscapedBackslash => "escaped-backslash".to_string(),
            SpanKind::EscapedBacktick => "escaped-backtick".to_string(),
            SpanKind::EscapedCaret => "escaped-caret".to_string(),
            SpanKind::EscapedColon => "escaped-colon".to_string(),
            SpanKind::EscapedGreaterThan => "escaped-greaterthan".to_string(),
            SpanKind::EscapedHyphen => "escaped-hyphen".to_string(),
            SpanKind::EscapedPipe => "escaped-pipe".to_string(),
            SpanKind::EscapedUnderscore => "escaped-underscore".to_string(),
            SpanKind::FootnoteShorthand => "footnote-shorthand".to_string(),
            SpanKind::GreaterThan => "greaterthan".to_string(),
            SpanKind::Hyphen => "hyphen".to_string(),
            SpanKind::LessThan => "lessthan".to_string(),
            SpanKind::LinkShorthand => "link-shorthand".to_string(),
            SpanKind::Newline => "newline".to_string(),
            SpanKind::MoreThanTwoCarets => "more-than-two-carets".to_string(),
            SpanKind::MoreThanTwoUnderscores => "more-than-two-underscores".to_string(),
            SpanKind::SingleBacktick => "single-backtick".to_string(),
            SpanKind::SingleCaret => "single-caret".to_string(),
            SpanKind::SingleGreaterThan => "single-greaterthan".to_string(),
