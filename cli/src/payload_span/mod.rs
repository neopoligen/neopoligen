...
impl PayloadSpan {
    pub fn new_from_span(span: &Span, config: &SiteConfig) -> PayloadSpan {
        ...
        let r#type = match &span.kind {
            ...
            SpanKind::EscapedCaret => "escaped_caret".to_string(),
            SpanKind::EscapedColon => "escaped_colon".to_string(),
            SpanKind::EscapedGreaterThan => "escaped_greaterthan".to_string(),
            SpanKind::EscapedHyphen => "escaped_hyphen".to_string(),
            ...
            SpanKind::MoreThanTwoCarets => "more_than_two_carets".to_string(),
            SpanKind::MoreThanTwoUnderscores => "more_than_two_underscores".to_string(),
            SpanKind::SingleBacktick => "singlebacktick".to_string(),
            SpanKind::SingleCaret => "single_caret".to_string(),
