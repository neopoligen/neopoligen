...
impl Page {
    pub fn test_with_output_path() -> Page {
        ...
        key_value_attributes_for_metadata.insert("id".to_string(), "id12345a".to_string());
        ...
        key_value_attributes_for_metadata.insert("path".to_string(), "/some-path/".to_string());
        ...
        Page {
            ...
            source_path: PathBuf::from("some-project-root/pages/bravo/bravo.neo"),
            source:
