...
impl Page {
    pub fn id12345c_tags() -> Page {
        ...
        key_value_attributes_for_metadata.insert("id".to_string(), "id12345c".to_string());
        ...
        flag_attributes_for_tags.insert("example_tag_bravo".to_string());

        Page {
            site: None,
            config: Config::mock_basic_config(),
            source_path: PathBuf::from("some-project-root/pages/delta/foxtrot/here-it-is.neo"),
            source:
