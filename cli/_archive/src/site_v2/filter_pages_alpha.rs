...
// impl SiteV2 {
//     pub fn filter_pages_alpha(&self, args: &[Value]) -> Vec<BTreeMap<&str, String>> {
//         let current_id = &args[0].clone().to_string();
//         let mut patterns: Vec<(BTreeSet<String>, BTreeSet<String>)> = vec![];
//         let _ = &args[1].try_iter().unwrap().for_each(|arg| {
...
//                 }
//             });
//             patterns.push((includes, exlcudes));
//             ()
//         });
