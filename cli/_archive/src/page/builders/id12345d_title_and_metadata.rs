...
impl Page {
    pub fn id12345d_title_and_metadata() -> Page {
        ...
        key_value_attributes_for_metadata.insert("id".to_string(), "id12345d".to_string());
        ...
        key_value_attributes_for_metadata
            .insert("extra_metadata".to_string(), "testing value".to_string());
        ...
        Page {
            ...
            source_path: PathBuf::from("some-project-root/pages/charlie/some-file.neo"),
            source:
