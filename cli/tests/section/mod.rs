...
use neopoligengine::section::SectionAttr;
...
fn basic_section_full_with_attrs() {
    ...
    attrs.insert("key".to_string(), "value1 value2".to_string());
    let mut attr_list = vec![];
    attr_list.push(SectionAttr::Flag {
        key: "flag".to_string(),
    });
    attr_list.push(SectionAttr::KeyValue {
        key: "key".to_string(),
