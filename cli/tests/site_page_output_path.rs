mod site_page_output_path {
    ...
    pub fn path_for_page_without_override_path() {
        ...
        let left = Some(
            "leading-dir/Neopoligen/test-site-2/docs/en/page-without-override-path/index.html"
                .to_string(),
        );
    ...
    pub fn home_page_override_path() {
        ...
        let config = Config::site2_config();
        let site = Site::new(&file_set, &config);
        let left = Some("leading-dir/Neopoligen/test-site-2/docs/index.html".to_string());
